...
public class Ejercicio8 : MonoBehaviour
{
    ...
    //correspondiente al valor de la variable “dia”. 
    //Si el día no está en el rango  permitido debe emitir por pantalla 
    //el mensaje de error "El día ingresado no es válido". 
    void Start()
    {
        switch (dia)
        {
